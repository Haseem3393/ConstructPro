    ...
    return (
      <SidebarLayout>
        <div className="flex flex-col items-center justify-center py-40 space-y-3">
          ...
          <p className="text-slate-505 text-sm font-semibold">Loading inventory analytics...</p>
        </div>
      </SidebarLayout>
    )
  }
    ...
    return (
      <SidebarLayout>
        <div className="p-8 text-center text-rose-455 bg-rose-500/10 border border-rose-500/22 rounded-xl space-y-4 max-w-md mx-auto">
          ...
          <p className="text-xs text-slate-400">Failed to load overview data. Try again later.</p>
        </div>
      </SidebarLayout>
    )
  }
      ...
      <div className="space-y-6">
        ...
        <div className="border-b border-[#1a2535] pb-5 flex flex-col sm:flex-row justify-between sm:items-center gap-4">
          <div>
            ...
            <p className="text-slate-405 text-xs font-semibold mt-1">Cross-project materials aggregation and safety levels tracking</p>
          </div>
          <Link
            to="/materials"
            className="inline-flex items-center justify-center px-4 py-2.5 bg-[#0b1220] hover:bg-[#111d33] text-slate-300 hover:text-white border border-[#1a2535] rounded-xl text-xs font-bold uppercase tracking-wider transition-all duration-200"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Card 1: Total Items */}
          <div className="bg-[#0d1526] border border-[#1a2535] rounded-xl p-6 shadow-xl flex items-center space-x-4">
            <div className="p-3 bg-blue-500/10 text-blue-400 border border-blue-500/22 rounded-xl">
              <Archive className="h-6 w-6" />
            </div>
            <div>
              <span className="block text-[10px] font-black text-slate-500 uppercase tracking-widest">Total Materials</span>
          ...
          <div className="bg-[#0d1526] border border-[#1a2535] rounded-xl p-6 shadow-xl flex items-center space-x-4">
            ...
            <div>
              <span className="block text-[10px] font-black text-slate-500 uppercase tracking-widest">Low Stock Alerts</span>
          ...
          <div className="bg-[#0d1526] border border-[#1a2535] rounded-xl p-6 shadow-xl flex items-center space-x-4">
            ...
            <div>
              <span className="block text-[10px] font-black text-slate-500 uppercase tracking-widest">Out of Stock</span>
          ...
          <div className="bg-[#0d1526] border border-[#1a2535] rounded-xl p-6 shadow-xl flex items-center space-x-4">
            ...
            <div>
              <span className="block text-[10px] font-black text-slate-500 uppercase tracking-widest">Inventory Value</span>
              <span className="text-xl font-black text-emerald-400 mt-1 block">{formatCurrency(overview.totalValue)}</span>
            </div>
          </div>
        </div>
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-[#1a2535] text-xs">
                  {overview.projectSummaries.map((ps) => (
                    <tr key={ps.projectId} className="hover:bg-white/[0.02] transition-colors">
                      <td className="py-4 px-6">
                        <div className="flex items-center space-x-2.5">
                          <Building2 className="h-4 w-4 text-blue-400 shrink-0" />
                          <div>
                            <span className="font-bold text-white block">{ps.projectName}</span>
                            <span className="text-[10px] text-slate-500">{ps.location}</span>
                          </div>
                        </div>
                      </td>
