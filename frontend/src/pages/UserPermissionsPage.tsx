    ...
    return (
      <SidebarLayout>
        <div className="flex flex-col items-center justify-center py-32 space-y-4">
          ...
          <p className="text-zinc-400 font-medium">Loading security descriptors...</p>
        </div>
      </SidebarLayout>
    )
  }
    ...
    return (
      <SidebarLayout>
        <div className="bg-rose-500/10 border border-rose-500/30 rounded-lg p-6 max-w-lg mx-auto text-center">
          <p className="text-rose-400 font-bold mb-2">Error loading descriptors</p>
    ...
    <SidebarLayout>
      <div className="space-y-6 max-w-2xl mx-auto">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-3xl font-extrabold text-white">Module Permissions</h1>
            <p className="text-zinc-400 text-sm mt-1">Configure role overrides for {userDetails.name} ({userDetails.role})</p>
          </div>
        </div>

        {/* Permissions Form */}
        <form onSubmit={handleSave} className="bg-[#14161f] border border-zinc-800 rounded-xl overflow-hidden shadow-xl p-6 space-y-6">
          {successMsg && (
          ...
          <div className="space-y-6 divide-y divide-zinc-800/80">
            ...
            <div className="pt-0 space-y-3">
              <div className="flex items-center space-x-2">
                ...
                <h3 className="font-bold text-sm text-zinc-200">Projects Module</h3>
              </div>
              <div className="flex flex-wrap gap-4 text-xs font-semibold text-zinc-350 pl-6">
                <label className="flex items-center space-x-2.5 cursor-pointer bg-[#1b1c25] border border-zinc-800/80 px-3 py-2 rounded-lg hover:border-zinc-700 select-none">
                  <input
                    type="checkbox"
            ...
            <div className="pt-5 space-y-3">
              <div className="flex items-center space-x-2">
                <ShieldCheck className="h-4 w-4 text-blue-500" />
                <h3 className="font-bold text-sm text-zinc-200">Finance & Expense Module</h3>
              </div>
              <div className="flex flex-wrap gap-4 text-xs font-semibold text-zinc-350 pl-6">
                <label className="flex items-center space-x-2.5 cursor-pointer bg-[#1b1c25] border border-zinc-800/80 px-3 py-2 rounded-lg hover:border-zinc-700 select-none">
                  <input
            ...
            <div className="pt-5 space-y-3">
              <div className="flex items-center space-x-2">
                <ShieldCheck className="h-4 w-4 text-blue-500" />
                <h3 className="font-bold text-sm text-zinc-200">Reports & Analytics</h3>
              </div>
              <div className="flex flex-wrap gap-4 text-xs font-semibold text-zinc-350 pl-6">
                <label className="flex items-center space-x-2.5 cursor-pointer bg-[#1b1c25] border border-zinc-800/80 px-3 py-2 rounded-lg hover:border-zinc-700 select-none">
                  <input
