    ...
    return (
      <SidebarLayout>
        <div className="flex flex-col items-center justify-center py-40 space-y-4">
          ...
          <p className="text-slate-400 font-medium text-sm">Syncing active payrolls...</p>
        </div>
      </SidebarLayout>
    )
  }
      ...
      <div className="space-y-8 fade-up">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-[#0d1526] border border-[#1a2535] p-5 rounded-2xl space-y-2 relative overflow-hidden shadow-lg">
            ...
            <span className="block text-[10px] font-black text-slate-600 uppercase tracking-widest">Active Laborers</span>
          ...
          <div className="bg-[#0d1526] border border-[#1a2535] p-5 rounded-2xl space-y-2 relative overflow-hidden shadow-lg">
            ...
            <span className="block text-[10px] font-black text-slate-600 uppercase tracking-widest">Average Daily Wage</span>
          ...
          <div className="bg-[#0d1526] border border-[#1a2535] p-5 rounded-2xl space-y-2 relative overflow-hidden shadow-lg">
            ...
            <span className="block text-[10px] font-black text-slate-600 uppercase tracking-widest">Daily Wage Liability</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 bg-[#0d1526] border border-[#1a2535] rounded-2xl p-6 flex flex-col justify-between shadow-lg relative overflow-hidden">
            ...
            <div className="my-6 relative">
              <svg viewBox="0 0 500 200" className="w-full h-48 overflow-visible">
                {/* Y-axis gridlines */}
                <line x1="40" y1="20" x2="500" y2="20" stroke="#1a2535" strokeDasharray="3 3" />
                <line x1="40" y1="70" x2="500" y2="70" stroke="#1a2535" strokeDasharray="3 3" />
                <line x1="40" y1="120" x2="500" y2="120" stroke="#1a2535" strokeDasharray="3 3" />
                <line x1="40" y1="170" x2="500" y2="170" stroke="#253550" />

                {/* X-axis base line */}
                <line x1="40" y1="170" x2="500" y2="170" stroke="#253550" strokeWidth="2" />
          ...
          <div className="bg-[#0d1526] border border-[#1a2535] rounded-2xl p-6 flex flex-col justify-between shadow-lg relative overflow-hidden">
            ...
            <h3 className="font-black text-sm text-white border-b border-[#1a2535] pb-3">Available Trade Categories</h3>
                ...
                {workers?.map((worker: any, idx: number) => (
                  <tr key={worker.id} className="hover:bg-white/[0.015] transition-colors">
                    ...
                    <td className="py-4 px-4">
                      <span className="inline-block px-2.5 py-0.5 text-[9px] font-extrabold rounded bg-[#0b1220] border border-[#1a2535] text-slate-350">
                        {worker.trade}
                      </span>
                    </td>
